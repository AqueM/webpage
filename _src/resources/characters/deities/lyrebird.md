...
{% endblock %}
{% block portrayal %}
Portrayals of Lyrebird keep in mind their shape-shifting nature and as such, there’s no standardised way to portray the deity. There’s as many versions of Lyrebird as there were artists trying to block their looks. The only recurring feature is the inclusion of a colourful feather, usually from a peacock, that lets people know that a specific piece of art is portraying Lyrebird.
{% endblock %}
{% block rituals %}
...
{% block bonus %}
{%- flex-stack -%}
{% theme__border-square %}<figure><blockquote>“Hearts starve as well as bodies: Give us Bread, but give us Roses.”</blockquote>  
<figcaption>(James Oppenheim, 1911)</figcaption></figure>{% endtheme__border-square %}
