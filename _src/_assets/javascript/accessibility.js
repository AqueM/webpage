...
const elementsToHide = [...document.getElementsByClassName("design__border-card__decor"), ...document.getElementsByClassName("side"), ...document.getElementsByClassName("icon"), ...document.getElementsByClassName("layout-image")];
